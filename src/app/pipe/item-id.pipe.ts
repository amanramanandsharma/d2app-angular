...
export class ItemIdPipe implements PipeTransform {
  ...
  public allItems = {
    ...
    transform(value: any): any {
      for (let key in this.allItems.items) {
        if(this.allItems.items[key].id == value) {
          return "http://cdn.dota2.com/apps/dota2/images/items/"+this.allItems.items[key].name+"_lg.png";
        }
      }
  }
